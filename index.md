...
venue: "R for Social Sciences"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Eve Bohnett"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Minghao Gong"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
{% unless site.curriculum == "dc-social sciences" or site.curriculum == "dc-genomics" or site.curriculum == "dc-socsci" or site.curriculum == "dc-geospatial" %}
